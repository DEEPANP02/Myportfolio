...
export default function App() {
  ...
  return (
    <>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "1.2rem 5%", display: "flex", justifyContent: "space-between", alignItems: "center", background: "rgba(8,5,16,0.85)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(124,58,237,0.1)" }}>
        ...
        <ul className="nav-desktop-links">
          ...
          <li style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            <a href="https://github.com/DEEPANP02" target="_blank" rel="noopener noreferrer" title="GitHub" style={{ color: "#6b5a8e", transition: "color 0.2s", display: "flex" }}
              onMouseEnter={e => e.currentTarget.style.color="#d8e4ff"} onMouseLeave={e => e.currentTarget.style.color="#6b5a8e"}>
            ...
            <a href="https://www.linkedin.com/in/deepan-p" target="_blank" rel="noopener noreferrer" title="LinkedIn" style={{ color: "#6b5a8e", transition: "color 0.2s", display: "flex" }}
              onMouseEnter={e => e.currentTarget.style.color="#a855f7"} onMouseLeave={e => e.currentTarget.style.color="#6b5a8e"}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 800 }}>
          <FadeUp>
            ...
            <div className="hero-btns" style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              ...
              <a
                href={`${import.meta.env.BASE_URL}Deepan_P_Resume.pdf`}
                download
                style={{ ...btnStyle, background: "transparent", border: "1px solid rgba(168,85,247,0.4)", color: "#a855f7", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "0.5rem" }}
              >
      ...
      <div style={{ background: "#100c1f", padding: "1.2rem 0", borderTop: "1px solid rgba(124,58,237,0.1)", borderBottom: "1px solid rgba(124,58,237,0.1)", overflow: "hidden" }}>
        <div style={{ display: "flex", width: "200%", gap: "4rem", animation: "mq 40s linear infinite" }}>
          {[...MQ_ITEMS, ...MQ_ITEMS].map((n, i) => (
            <span key={i} style={{ fontSize: "0.75rem", fontWeight: 800, textTransform: "uppercase", color: "#6b4fa0", letterSpacing: "0.22em", whiteSpace: "nowrap" }}>{n}</span>
          ))}
        </div>
      </div>

      {/* Sections */}
      <section id="skills" style={{ padding: "120px 5%", background: "rgba(8, 5, 16, 0.65)", position: "relative", zIndex: 1 }}>
        <FadeUp>
      ...
      <section id="experience" style={{ padding: "120px 5%", background: "rgba(16, 12, 31, 0.65)", position: "relative", zIndex: 1, borderTop: "1px solid rgba(124,58,237,0.1)", borderBottom: "1px solid rgba(124,58,237,0.1)" }}>
        <FadeUp>
          <Label>Career</Label>
      ...
      <section id="projects" style={{ padding: "120px 5%", background: "rgba(8, 5, 16, 0.65)", position: "relative", zIndex: 1 }}>
        <FadeUp>
          <Label>Gallery</Label>
